...
window.onload = function initCube() {
	...
	changeLoc = gl.getUniformLocation(program, "change");
    gl.uniform3fv(changeLoc, change);

    document.getElementById("changex").onclick = function () {
        change[xAxis] = document.getElementById("changex").value;
    }

    document.getElementById("changey").onclick = function () {
        change[yAxis] = document.getElementById("changey").value;
    }

    document.getElementById("changez").onclick = function () {
        change[zAxis] = document.getElementById("changez").value;
    }
